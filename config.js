...
const RENTAL_SAMPLE_PRODUCTS = [
  {brand:'HP',category:'데스크탑',name:'Pro Tower 280 G9',spec:'CPU: Intel i3,i5,i7 14세대 / RAM: DDR5 8GB ~ / SSD: NVMe 256GB~ / VGA: 내장그래픽 / OS: Windows11pro',daily_price:3000,monthly_price:60000,is_active:true},
  {brand:'HP',category:'데스크탑',name:'Elite Tower 800 G9',spec:'CPU: Intel i5,i7,i9 14세대 / RAM: DDR5 8GB ~ / SSD: NVMe 256GB~ / VGA: 내장그래픽 / OS: Windows11pro',daily_price:3500,monthly_price:70000,is_active:true},
  {brand:'HP',category:'워크스테이션',name:'Z2 G9 Tower',spec:'CPU: Intel i7,i9 14세대 / RAM: DDR5 8GB ~ / SSD: NVMe 256GB~ / OS: Windows11pro',daily_price:8000,monthly_price:160000,is_active:true},
  {brand:'HP',category:'워크스테이션',name:'Z4 G5 Tower',spec:'CPU: Intel Xeon W3,W5,W7 / RAM: DDR5 ECC 16GB ~ / SSD: NVMe 256GB~ / OS: Win11 for Workstations',daily_price:10000,monthly_price:200000,is_active:true},
  {brand:'HP',category:'모바일워크스테이션',name:'ZBook Fury G1i 16',spec:'크기: 16 inch / CPU: Intel Ultra U5,U7 / RAM: DDR5 8GB ~ / SSD: NVMe 256GB~ / OS: Windows11pro',daily_price:7000,monthly_price:140000,is_active:true},
  {brand:'HP',category:'노트북',name:'ProBook 4 G1i',spec:'크기: 14/16 inch / CPU: Intel Ultra U5,U7 / RAM: DDR5 8GB ~ / SSD: NVMe 256GB~ / OS: Windows11pro',daily_price:4000,monthly_price:80000,is_active:true},
  {brand:'Samsung',category:'노트북',name:'NT751XHD',spec:'크기: 15.6 inch / CPU: Intel Ultra U5,U7 / RAM: DDR5 16GB / SSD: NVMe 256GB~ / OS: Windows11pro',daily_price:4000,monthly_price:80000,is_active:true},
  {brand:'Lenovo',category:'데스크탑',name:'ThinkCentre neo 50t',spec:'CPU: Intel Ultra U3,U5,U7 / RAM: DDR5 8GB ~ / SSD: NVMe 256GB~ / OS: Windows11pro',daily_price:3000,monthly_price:60000,is_active:true},
  {brand:'HP',category:'모니터',name:'324pe',spec:'크기: 24 inch / 해상도: FHD 1920*1080 / 패널: IPS / 연결단자: HDMI, DP, VGA',daily_price:1500,monthly_price:30000,is_active:true},
  {brand:'Samsung',category:'모니터',name:'LS27D304GAKXKR',spec:'크기: 27 inch / 해상도: FHD 1920*1080 / 패널: IPS / 연결단자: HDMI, VGA',daily_price:1500,monthly_price:30000,is_active:true}
];
